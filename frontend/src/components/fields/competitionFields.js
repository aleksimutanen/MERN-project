...
const houseSchema = Yup.object().shape({
  ...
  hectareCount: Yup.number().required()
})


const CompetitionFormFields = ({ sendFields, project }) => {
          ...
          errors,
            ...
            <Form noValidate onSubmit={handleSubmit} encType='multipart/form-data'>
              ...
              <Form.Row>
                ...
                <Col>
                  <Form.Group>
                    <Form.Label>hectare count</Form.Label>
                    <Form.Control
                      type='number'
                      placeholder='number'
                      aria-describedby='inputGroupPrepend'
                      name='hectareCount'
                      value={values.hectareCount}
                      onChange={handleChange}
                      isInvalid={!!errors.hectareCount}
                    />
                  </Form.Group>
                </Col>
