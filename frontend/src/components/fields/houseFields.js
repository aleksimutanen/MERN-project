...
const houseSchema = Yup.object().shape({
  ...
  floorAreaM2: Yup.number().required(),
  apartmentCount: Yup.number().required(),
  parkingAreaM2: Yup.number().required(),
  parkingspotsCount: Yup.number().required()
})


const HouseFormFields = ({ sendFields, project }) => {
          ...
          errors,
            ...
            <Form noValidate onSubmit={handleSubmit} encType='multipart/form-data'>
                ...
                <Col>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      onChange={handleChange}
                      // isInvalid={!!errors.mainDesigner}
                      isInvalid={values.mainDesigner === values.assistantDesigner}
                    >
                      {employees.map((e, i) =>
                ...
                <Col>
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      onChange={handleChange}
                      // isInvalid={!!errors.assistantDesigner}
                      isInvalid={values.assistantDesigner === values.mainDesigner}
                    >
                      {employees.map((e, i) =>
                        <option key={i}>{e.name}</option>
                      )}
              ...
              <Form.Row>
                ...
                <Col>
                  <Form.Group>
                    <Form.Label>apartment count</Form.Label>
                    <Form.Control
                      type='number'
                      placeholder='number'
                      aria-describedby='inputGroupPrepend'
                      ...
                      onChange={handleChange}
                      isInvalid={!!errors.apartmentCount}
                    />
                  </Form.Group>
                </Col>
